package rj.nexus.systems.bedrock.particle.util;

import rj.nexus.systems.bedrock.particle.component.ParticleComponents;
import rj.nexus.systems.bedrock.particle.NexusParticleEmitter;
...
public class ShapeUtil {
    public static NexusParticleEmitter.InitialParticleData initialParticleData(MolangRuntime runtime, NexusParticleEmitter holder) throws MolangRuntimeException {
        ...
        if (point != null) {
            ...
            return NexusParticleEmitter.InitialParticleData.of(new Vec3(x, y, z), new Vec3(dx, dy, dz));
        }
        ...
        if (sphere != null) {
            ...
            if (sphere.directionList != null) {
                ...
                return NexusParticleEmitter.InitialParticleData.of(v, new Vec3(dlx, dly, dlz));
            } else if (sphere.direction == EmitterDirection.INWARDS) {
                n = n.reverse();
            }

            return NexusParticleEmitter.InitialParticleData.of(v, n);
        }
        ...
        return NexusParticleEmitter.InitialParticleData.ZERO;
    }
}
